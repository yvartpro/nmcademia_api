const { sequelize, Country, Package, PackagePrice, Product, FAQ, Setting, Testimonial, Founder, ManufacturingPartner, EarningStream } = require('./models');
  ...
  try {
    ...
    const settings = [
      ...
      },
      {
        ...
        value: 'Network Marketing Academy is not here to entertain you—it is here to confront you. The world you were prepared for is no longer the world you are living in. Jobs are shrinking, automation is rising, inflation is eating salaries, and the promise that education alone guarantees freedom is quietly collapsing. Yet most people still wait, hoping the old system will somehow fix what it has already outgrown.\n\nThis is a new economy. Power no longer belongs to those who simply work hard, but to those who understand networks, influence, and digital connection. Network Marketing Academy exists to train a generation that refuses dependency—people who build, lead, and create income through human networks instead of waiting for permission. The only real question now is not whether the world is changing—but whether you will change with it or be left explaining why you didn’t.',
        description: 'Landing Page Hero confrontational statement'
      },
      {
        key: 'mission_statement',
        value: 'Network Marketing Academia is not just a platform.\nIt is a wake-up call.\nThe world is changing faster than most people are prepared for.\nWork is being automated. Careers are being redefined.\nInflation is rising while salaries remain stagnant, making traditional income increasingly insufficient.\nAnd traditional education is no longer a guaranteed path to freedom.\nYet millions still wait for systems that are already evolving beyond them.\nNetwork Marketing Academia exists to educate a new generation of thinkers, leaders, and builders who understand that the future belongs to those who can create networks, influence people, and build communities in the digital age.\nNetwork marketing is more than selling products.\nIt is the science of human connection.\nIt is leadership multiplied through people.\nIt is entrepreneurship powered by networks.',
        description: 'Academia Mission statement text'
      },
      {
        key: 'objectives_statement',
        value: 'For decades, wealth was controlled by corporations, institutions, and gatekeepers.\nToday, technology has changed the rules.\nAn ordinary person with vision, communication skills, and persistence can now build an international organization from a smartphone.\nThat is why network marketing is considered one of the defining business models of the 21st century.\nIt allows people to start with limited capital.\nIt rewards leadership, duplication, consistency, and growth.\nIt transforms relationships into economic ecosystems.\nMost people look at network marketing and only see “selling.”\nJust like someone standing in a rice field before harvest may only see grass.\nBut vision changes everything.',
        description: 'Academia Objectives'
      },
      {
        key: 'vision_statement',
        value: 'Some see impossibility.\nOthers see the future before it arrives.\nNetwork Marketing Academia was created for those who refuse to remain spectators in a changing world.\nFor those willing to learn, grow, lead, and build.\nBecause in the modern economy:\nNetworks are power.\nKnowledge is leverage.\nAnd those who master both will shape the future.',
      ...
      },
      {
        ...
        value: 'Congratulations for becoming a distributor in the network marketing industry. You have made a decision that millions of people are too afraid to take. While most people only talk about changing their lives, you decided to step into a business that rewards courage, growth, leadership, and vision.\n\nYou are here because you want to learn more, grow faster, and take your business to another level. That is the mentality of serious leaders. In network marketing, the people who continue learning are the people who continue earning.\n\nThis industry is not only about products, compensation plans, or recruiting people. Network marketing is a people development business. If you do not learn how to communicate, inspire, lead, train, and build people, it becomes extremely difficult to create long-term success.',
      ...
      },
      {
        ...
        value: 'You are entering a multibillion-dollar global industry where millions around the world are building income, developing leadership, and transforming their financial future through networks and digital systems.\n\nWherever you are starting from, this system is designed for people who want to learn, grow, and build in the modern network-driven economy. If you are ready to explore a different path, you are in the right place.',
      ...
      },
      {
        ...
        value: 'Network Marketing Academia operates as an independent educational and training platform that helps individuals understand modern network-based entrepreneurship.\n\nOur practical business model and real-world opportunity are provided through a partnership with Alliance In Motion Global Group of Companies (AGG).\n\nNetwork Marketing Academia prepares you for the network economy. Alliance In Motion Global provides the real-world system where that knowledge is applied.',
        description: 'Partner company intro paragraph shown at the top of the Presentation page'
      },
      {
        key: 'partner_company_profile',
        value: 'Alliance In Motion Group of Companies (AGG) is an international network marketing company founded in 2006 in the Philippines. The company specializes in health, wellness, and empowerment products while helping people build businesses, develop leadership skills, and create long-term income through network marketing.\n\nWe have partnerships with several banks in Africa and outside Africa, including Access Bank, Zenith Bank, Ecobank, Fidelity Bank, and others.\n\nOur products are divided into different categories: food supplements, beverages, personal care products, weight loss products, and children\'s products.',
        description: 'Full partner company profile text'
      },
      {
        key: 'dream_section_text',
        value: 'Most people will never live their dreams — not because dreams are fake, but because they chose a life that only pays bills. You cannot build a millionaire dream with a survival system.\n\nThe uncomfortable truth: many people secretly want freedom but stay in paths that were never designed to create it. Some professions maintain life. Few create leverage. That is why more people are turning to network marketing — not because it is easy, but because they are tired of watching their dreams remain an illusion.',
      ...
      },
      {
        ...
        value: 'NB: These are the official prices in countries where the company already has established offices. If your country does not yet have an official office, consider yourself fortunate — you have a rare opportunity to pioneer the business in your nation. Remember, one of the most powerful principles of wealth creation is positioning yourself among the first movers in any successful system. Early entry often determines long-term success.\n\nTo these prices, a shipping and delivery fee from our headquarters to your country will be added. This is how we ensure you receive your package anywhere in the world.',
    ...
    const faqs = [
      ...
      },
      {
        ...
        answer: 'The difference is in structure, mentorship, and duplication. You are not building alone—you are following a system designed to be replicated.'
      },
      {
        order: 25,
      ...
      },
      {
        ...
        answer: 'That mindset is very common because most people were raised and educated to become employees, not builders. School trained many people to follow instructions, look for jobs, obey systems, and depend on salaries. But every major success story in human history was built through people, leadership, and teamwork.\n\nNo great movement was ever built alone.\n• Henry Ford built teams to grow the automobile industry.\n• Steve Jobs built teams that transformed technology.\n• Elon Musk leads thousands of people to build global companies.\n• Politicians recruit supporters.\n• Churches recruit believers.\n• Sports clubs recruit players.\n• Governments recruit workers.\n\nEven Jesus Christ did not work alone. He built a team of 12 disciples who helped spread Christianity across the world. Today, billions of people know Christianity because of teamwork, duplication, and leadership. The same principle exists in other major religions and organizations worldwide — one person shares with others, and those people continue sharing with more people.\n\nRecruiting in network marketing is not forcing people. It is simply sharing an opportunity that can help someone financially, physically, or personally. The people who fear recruiting are often those conditioned to think only in terms of employment, where success depends only on working for someone else. But business owners, entrepreneurs, and leaders understand that long-term growth always comes through building people and creating strong teams.'
      }
    ];
    ...
    await Founder.bulkCreate([
      ...
      { name: 'Engr. Francis Miguel', initials: 'FM', role: 'Chief Finance Officer', title: 'Engr.', bio: 'Pioneering the corporate finance systems ensuring safe, fast commission payouts. He oversees the financial infrastructure that supports millions of distributors worldwide.', order: 2 },
      { name: 'John Asperin', initials: 'JA', role: 'Chief Marketing Officer', title: 'Mr.', bio: 'Crafting marketing strategies and distribution pathways that engage millions. John leads global business development and has grown AIM Global into an international powerhouse.', order: 3 }
    ]);
    ...
    await ManufacturingPartner.bulkCreate([
      ...
      { name: 'DSM', country: 'Europe', description: 'Science-based nutrition & lipid supplement solutions. A global leader in vitamins, carotenoids, and other micronutrients.', order: 2 },
      { name: 'Weider', country: 'USA', description: 'Active nutrition & sports medicine manufacturing. Pioneer in sports supplements and health products since 1936.', order: 3 },
